...
#Makes Chain Breaker Shoot 3 bullets
func shoot():
	...
	var bullet_straight_left             = bullet_scene.instance()               #Creates instance of the bullet that's going straight left
	var bullet_straight                  = bullet_scene.instance()               #Creates instance of the bullet that's going straight
	var bullet_straight_right            = bullet_scene.instance()               #Creates instance of the bullet that's going straight right
	...
	get_parent().add_child(bullet_straight_left)                                 #Spawns in bullet_straight_left
	bullet_straight_left.rotate(1.48353)                                         #Rotates bullet_straight_left 85 degrees based on the direction of the Position2D node
	bullet_straight_left.speed           = 200                                   #Makes bullet_straight_left's speed 200
	...
	get_parent().add_child(bullet_straight_right)                                #Spawns in bullet_straight_right
	bullet_straight_right.rotate(1.658063)                                       #Rotates bullet_straight_right 95 degrees based on the direction of the Position2D node
	bullet_straight_right.speed          = 200                                   #Makes bullet_straight_right's speed 200
	...
	bullet_straight_left.position        = $Position2D.global_position           #Makes the position of bullet_straight_left's the same as Position2D
	bullet_straight_right.position       = $Position2D.global_position           #Makes the position of bullet_straight_right's the same as Position2D
